            ...
            <section class="sidebar">      
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="../../index.html"><i class="fa fa-minus"></i> Generar Boleta</a></li>
                            <li><a href="../../index.html"><i class="fa fa-minus"></i> Generar Factura</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="../../index.html"><i class="fa fa-minus"></i> Categorias</a></li>
                            <li><a href="../../index.html"><i class="fa fa-minus"></i> Clientes</a></li>
                            <li><a href="../../index.html"><i class="fa fa-minus"></i> Productos</a></li>
                            <li><a href="../../index.html"><i class="fa fa-minus"></i> Ventas</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
