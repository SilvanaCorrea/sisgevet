...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="box box-danger">
            ...
            <form class="form-horizontal" action="<?php echo base_url();?>mantenimiento/presentacion/store" method="POST">
              <div class="box-body">
                <div class="form-group">
                  <label for="nombre" class="col-sm-2 control-label">Nombre:</label>
                  <div class="col-sm-10">
                      <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre de presentación">
                  </div>
                </div>
                <div class="form-group">
